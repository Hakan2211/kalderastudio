...
/**
 * The whole post stack lives in this module so `postprocessing` and its
 * @react-three wrapper land in a chunk of their own instead of riding along
 * with three + fiber in CalderaCanvas. Nothing here is imported statically by
 * the canvas — see the lazy() there.
 */
